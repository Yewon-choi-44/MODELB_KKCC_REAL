...
**model B**는 학습 효율을 완벽하게 서포트하기 위해, 생성형 AI인 **Stable Diffusion 3.5(SD3.5)**를 기반으로 형태를 정밀 제어하는 **ControlNet**, 소량 데이터 맞춤형 고효율 미세조정 기술인 **DoRA**, 그리고 미세 질감을 현미경 수준으로 다듬는 **SUPIR** 기술을 결합한 조립식 모듈형 파이프라인을 구축했습니다. 
...
# 요약 : Stable Diffusion 3.5 Large + Full fine tunning + ControlNet (Canny + Depth) + SUPIR
